...
namespace tests
{
    ...
    public class SessionTests
    {
        ...
        public void TestSyncSettings()
        {
            ...
            mockStreamWriter.Setup(m => m.WriteAsync(It.Is<Proto.TelemetryCommand>(tc => tc.Settings == settings))).Returns(Task.CompletedTask);
            testClient.SetClientManager(mockClientManager.Object);

            session.SyncSettings(true);
